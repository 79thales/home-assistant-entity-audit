...
class FrontendContractTest(unittest.TestCase):
    ...
    def test_label_pdf_export_is_limited_to_unique_ip_addresses(self) -> None:
        ...
        self.assertIn("const variant = this._labelVariant", frontend)
        self.assertIn('if (variant === "qr")', frontend)
        self.assertIn("_fitTronicTitle", frontend)
        self.assertIn("y + padding,\n        combinedQrSize", frontend)
