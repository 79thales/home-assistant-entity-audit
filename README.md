...
- adds an Automations & scripts category with runtime status, type and state filters, a UTF-8 CSV inventory export, and separate sanitized YAML exports for the currently filtered automations and scripts;
